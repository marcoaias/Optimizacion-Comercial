...
xmin=0,
% ticks=none,
xtick={9,94,183,211,289, 240,320},
    xticklabels={A, B, C, D, E*, {\tiny 3er vg. completo}, {\tiny 4o vg. completo}},
%domain=3:20,
%samples=200,
...
\addplot[densely dotted, ultra thick, darkgray] coordinates {(80,0) (80,1)};
\addplot[densely dotted, ultra thick, darkgray] coordinates {(160,0) (160,1)};
\addplot[densely dotted, ultra thick, darkgray] coordinates {(240,0) (240,1)};
\addplot[densely dotted, ultra thick, darkgray] coordinates {(320,0) (320,1)};
...
Se define una función de coste y beneficio, $\delta(\theta)$, la cuál recoge el beneficio neto en función del número de pasajeros $\theta$ y conversamente, del número de vagones aplicando las tasas asociadas.\\
...
\begin{align}
\delta(\theta) = \sum_{k=1}^\theta \underset{\left\{\min(i) \, \mid \, k \, < \, \theta_i^*\right \}}{\text{Tarifa}_i} - \left(\left\lceil\dfrac{\theta}{n_{\text{plazas}}}\right\rceil \cdot \frac{\text{Coste}}{\text{vagón}} + \theta\cdot\frac{\text{Tasa}}{\text{pasajero}} \right)
\end{align}

\begin{align}
\delta(\theta)^* = \sum_{k = 1}^\theta \underset{\left\{\min(i) \, \mid \, k \, < \, \theta_i^*\right \}}{\left[\left(\text{Tarifa}_i -\frac{\text{Tasa}}{\text{pasajero}}\right)\left(1 - \underset{(\overline{\mu}_i, \, \overline{\sigma}_i)}{P(\theta)}\right)\right]} - \left\lceil\dfrac{\theta}{n_{\text{plazas}}}\right\rceil \frac{\text{Coste}}{\text{vagón}}
\end{align}
...
\addplot [red, densely dashdotted, thick, domain=0:200] {1};
\addplot [red, ultra thick] table{data/vprob0.dat};
% \addplot [ForestGreen, densely dashdotted, thick] table{data/vprob1.dat};

\addplot [ForestGreen, densely dashdotted, ultra thick] table{data/vprob3.dat};
...
\caption{Distintas funciones $\delta$, según distintas probabilidades de demanda}\label{fig:distvag}
\end{figure}
